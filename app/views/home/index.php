...
<div class="container">
    ...
    echo "<a href='/home/mylogIn'>My LogIn(Previous Attempts)</a>";
    echo "</br>";
    echo "<a href='/home/create'>New Note</a>";
    require_once '../app/controllers/userAdmin.php';
    $_index = new userAdmin();
    $result = $_index -> index();
    ...
    foreach($result as $row)
    {
        ...
        echo "<td>";
        echo "<a href='/userAdmin/delete?id={$row['reminderID']}'>Remove</a>";       
        echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
